...
export class AuthService {
  ...
  authenticateByRFID(uid: string): Observable<any> {
    const url = 'https://trafic-backend.onrender.com/api/authenticate-rfid'; // Remplace par l'URL de ton backend Laravel
  ...
  resetCodeSecret(email: string): Observable<any> {
    const url = 'https://trafic-backend.onrender.com/api/utilisateurs/reset-code';
